...
stream.on('end', function() {
    ...
    process.stderr.write('TL by Mapbox: ' + String(bl_mapboxCount) + '\n');
    process.stderr.write('TL by Others: ' + String(bl_otherCount) + '\n');
    process.stderr.write('TL by Mapbox: ' + String(nref_mapboxCount) + '\n');
    process.stderr.write('TL by Others: ' + String(nref_otherCount) + '\n');
    process.stderr.write('TL by Mapbox: ' + String(ref_mapboxCount) + '\n');
    process.stderr.write('TL by Others: ' + String(ref_otherCount) + '\n');
    process.stderr.write('TL by Mapbox: ' + String(des_mapboxCount) + '\n');
    process.stderr.write('TL by Others: ' + String(des_otherCount) + '\n');
});
